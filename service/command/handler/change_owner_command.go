 ...
 */
type ChangeOwnerCommandHandler[W common.ModelWrapper, T common.Model, C command.Command] struct {
	EntityName string
 ...
 * Handle Command.
 */
func (ch *ChangeOwnerCommandHandler[W, T, C]) Handle(ctx context.Context,
	cmd command.Command,
 ...
 */
func (ch *ChangeOwnerCommandHandler[W, T, C]) changeOwner(ctx context.Context, id string, owner account.MiniUser) (*T, error) {
