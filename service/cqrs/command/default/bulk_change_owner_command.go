 ...
 */
type BulkChangeOwnerCommandHandler[M shared.Model, C command.Command] struct {
	EntityName string
	Repository repository.Repository[M]
}

type BulkChangeOwnerCommandHandlerContext[M shared.Model, C command.Command] struct {
